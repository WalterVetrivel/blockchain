...
class Blockchain:
    ...
    def load_data(self):
        try:
            with open('blockchain.txt', mode='r') as f:
                ...
                self.open_transactions = [Transaction(tx['sender'], tx['recipient'], tx['amount']) for tx in
                                          open_transactions]
    ...
    def mine_block(self):
        ...
        copied_transactions = self.open_transactions[:]  # copies open_transactions by value (: signifies range, if nothing is
